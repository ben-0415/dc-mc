...
class Material {
    ...
    async get(options) {
        ...
        const response = await api_1.axiosInstance.post('/get_entry_page_list', {
            ...
            menu_id: "9" /* EntryPageMenu.Material */,
        ...
        throw new HoYoWikiAPIError_1.HoYoWikiAPIError(((_e = response.data) === null || _e === void 0 ? void 0 : _e.message) || 'Unable to get material data.', (_f = response.data) === null || _f === void 0 ? void 0 : _f.retcode);
    }
    /**
     * @param {EntryPageDataOptions | undefined} options
     *
