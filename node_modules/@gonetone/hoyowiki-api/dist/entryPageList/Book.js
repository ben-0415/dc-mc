...
class Book {
    ...
    async get(options) {
        ...
        throw new HoYoWikiAPIError_1.HoYoWikiAPIError(((_e = response.data) === null || _e === void 0 ? void 0 : _e.message) || 'Unable to get book data.', (_f = response.data) === null || _f === void 0 ? void 0 : _f.retcode);
    }
    /**
     * @param {EntryPageDataOptions | undefined} options
     *
